...
export const USERS_SUB_ROUTE = "users"
...
export const USER_SUB_ROUTE = USERS_SUB_ROUTE + "/" + USER_ID_PLACEHOLDER
...
export const APP_USERS_ROUTE = APP_ROUTE + "/" + USERS_SUB_ROUTE
export const APP_USER_ROUTE = APP_USERS_ROUTE + "/" + USER_ID_PLACEHOLDER
...
export const appUserRoute = (userId: string) => APP_USER_ROUTE.replace(USER_ID_PLACEHOLDER, userId)
